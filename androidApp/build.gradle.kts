...
android {
    namespace = "com.wiryadev.kotranslate.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.wiryadev.kotranslate.android"
        minSdk = 23
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.wiryadev.kotranslate.HiltTestRunner"
    }
    buildFeatures {
        compose = true
    }
